...
**Obs7: Project Rendering AI Command in 3 Axis using N Dimensions using external library as GPGPU with OpenCL 3, OpenGL Rendering using BGRA Colors, OpenAL for spatial audio and SDL2 for Windows Management.**
